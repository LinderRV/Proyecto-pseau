<x-guest-layout>
    ...
    <div class="flex space-x-2 mb-6">
        <a href="{{ route('login') }}" class="flex-1 py-2 px-4 bg-white text-blue-500 text-center font-medium rounded-md hover:bg-gray-100">
            {{ __('INICIAR SESIÓN') }}
        </a>
        <a href="{{ route('register') }}" class="flex-1 py-2 px-4 bg-blue-500 text-white text-center font-medium rounded-md">
            {{ __('REGISTRARSE') }}
        </a>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="ajax-form">
        ...
        <div class="mb-4 relative">
            <div class="flex items-center">
                ...
                <x-text-input id="name" class="pl-10 form-input focus:shadow-input" 
        ...
        <div class="mb-6 relative">
            <div class="flex items-center">
                ...
                <x-text-input id="password_confirmation" class="pl-10 form-input focus:shadow-input"
                    placeholder="Confirmar Contraseña"
                    type="password"
                    name="password_confirmation" 
                    required 
                    autocomplete="new-password" />
                <div class="absolute right-3 top-3 text-gray-400 cursor-pointer toggle-confirm-password">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 show-password">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
        ...
        <!-- Google Registration -->
        <div class="mt-4">
            <a href="{{ route('auth.google') }}" class="btn btn-outline w-full flex items-center justify-center">
