            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold text-gray-800">Crear Nuevo Curso</h2>
                                    ...
                                    @foreach($careers as $career)
                                        <div class="flex items-start">
                                            <div class="flex items-center h-5">
                                                <input id="career_{{ $career->id }}" name="careers[]" type="checkbox" value="{{ $career->id }}" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" {{ in_array($career->id, old('careers', [])) ? 'checked' : '' }}>
                                            </div>
